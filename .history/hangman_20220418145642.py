...
While len(wordsList) > 0:
    ...
    # ' '.join(['a', 'b', 'cd']) --> 'a,b,cd'
    print('you have used the following letters: ',' '.joined(user_letter))
    
    #what is the current word they are guessing(ex: l _ O _)
    wordsList = [letter if letter in user_letters else '-' for letter in word]
